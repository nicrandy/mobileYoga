...
def getPoseLandmarks(folderLocation):
    ...
    for name in os.listdir(namesFolder):
        ...
        poseInfo = imageName[0].split("_")
        poseNumber = poseInfo[0]
        frontOrSide = poseInfo[2]
        ...
        # except IndexError:
        #     pass
        # print("1     front or side", frontOrSide)

        # try:
        #     frontOrSide = frontOrSide[0].split('_')
        # except IndexError:
        #     pass
        # print("2      front or side", frontOrSide)
        # frontOrSide = splitFileName[2]
        # print("poseNumber", poseNumber, "frontOrSide", frontOrSide)
        if count > 0:
            with mp_pose.Pose(
                    static_image_mode=True,
